...
<section class="hero">
	<div class="container hero-grid">
		<div class="hero-content">
			...
			<h1><?php esc_html_e( 'As melhores', 'guru-do-desconto' ); ?> <span><?php esc_html_e( 'promoções', 'guru-do-desconto' ); ?></span> <?php esc_html_e( 'chegam primeiro no nosso grupo', 'guru-do-desconto' ); ?></h1>
		...
		<div class="hero-image">
			<img src="<?php echo esc_url( GURU_THEME_URI . '/assets/images/Guru_sem_fundo.png' ); ?>"
			     alt="<?php esc_attr_e( 'Guru do Desconto — mascote', 'guru-do-desconto' ); ?>"
