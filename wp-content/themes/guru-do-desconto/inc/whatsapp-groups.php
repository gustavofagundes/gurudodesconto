...
function guru_whatsapp_groups() {
	...
	return array(
		array(
			...
			'hook'             => __( 'Já viu promoção boa sumir em minutos? Selecionamos as melhores oportunidades do Mercado Livre, Shopee e Amazon todo dia — grupo 100% grátis, sem custo nenhum.', 'guru-do-desconto' ),
		...
		array(
			...
			'hook'             => __( 'Sua air fryer ou geladeira dos sonhos pode estar em promoção agora — e você nem sabia. Filtramos só as melhores oportunidades de casa e eletro. Entrada 100% grátis.', 'guru-do-desconto' ),
		...
		array(
			...
			'hook'             => __( 'Aquela oferta de skincare que você quase comprou… pode ter caído de preço hoje. Selecionamos os melhores achadinhos de beleza e moda — grupo gratuito, sem pegadinha.', 'guru-do-desconto' ),
		...
		array(
			...
			'hook'             => __( 'Fralda em promoção acaba rápido — toda mamãe sabe. Caçamos as melhores oportunidades de bebê e criança antes que esgotem. Grupo 100% grátis, feito para você.', 'guru-do-desconto' ),
		...
		array(
			...
			'hook'             => __( 'PS5 ou notebook abaixo do preço? Isso aparece poucas vezes no ano. Selecionamos as melhores oportunidades de tech e games — alerta grátis, direto no WhatsApp.', 'guru-do-desconto' ),
		...
		array(
			...
			'hook'             => __( 'Presente barato e bom existe — o truque é saber onde achar. Filtramos as melhores oportunidades abaixo de R$ 50 todo dia. Grupo 100% gratuito.', 'guru-do-desconto' ),
		...
		array(
			...
			'hook'             => __( 'Tênis de marca com metade do preço não cai do céu — alguém precisa te avisar. Curamos as melhores oportunidades de moda masculina e grooming. Entrada 100% grátis.', 'guru-do-desconto' ),
