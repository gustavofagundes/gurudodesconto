...
function guru_whatsapp_groups() {
	...
	return array(
		...
		array(
			'slug'             => 'shopee',
			'name'             => __( 'Shopee', 'guru-do-desconto' ),
			'hook'             => __( 'Achadinho da Shopee por menos de R$ 20? Quem está no grupo recebe antes de esgotar.', 'guru-do-desconto' ),
			'headline'         => __( 'Promoções, cupons e achadinhos Shopee selecionados todo dia. Grupo 100% grátis.', 'guru-do-desconto' ),
			'promise'          => __( 'Ofertas relâmpago, cupons e frete grátis da Shopee — direto no seu WhatsApp.', 'guru-do-desconto' ),
			'tagline'          => __( 'Achadinhos e cupons Shopee', 'guru-do-desconto' ),
			'description'      => __( 'Grupo focado em promoções da Shopee — achadinhos, cupons, frete grátis e ofertas relâmpago selecionados para você.', 'guru-do-desconto' ),
			'social_proof'     => __( 'Quem ama comprar na Shopee já recebe os melhores achadinhos do dia no grupo.', 'guru-do-desconto' ),
			'urgency'          => __( 'Promoção Shopee esgota em minutos — alerta só para quem entrou no grupo.', 'guru-do-desconto' ),
			'cta_primary'      => __( 'Participar do Grupo Shopee', 'guru-do-desconto' ),
			'cta_sticky'       => __( 'Participar do Grupo Agora', 'guru-do-desconto' ),
			'cta_card'         => __( 'Participar Gratuitamente', 'guru-do-desconto' ),
			'teaser_items'     => array(
				__( 'Cupom Shopee com frete grátis', 'guru-do-desconto' ),
				__( 'Achadinho abaixo de R$ 15', 'guru-do-desconto' ),
				__( 'Oferta relâmpago com 60% off', 'guru-do-desconto' ),
			),
			'url'              => 'https://chat.whatsapp.com/IqBfSnqeq6WF2MNg3DMAti?mode=gi_t',
			'image'            => $base . 'grupo-shopee.png',
			'keywords'         => 'promoções shopee whatsapp, achadinhos shopee, cupom shopee',
			'meta_description' => 'Grupo Shopee no WhatsApp — achadinhos, cupons e promoções selecionadas todo dia. 100% grátis. Entre agora!',
			'benefits'         => array(
				__( 'Cupons e frete grátis Shopee', 'guru-do-desconto' ),
				__( 'Achadinhos abaixo de R$ 30', 'guru-do-desconto' ),
				__( 'Ofertas relâmpago do dia', 'guru-do-desconto' ),
				__( 'Só o melhor da Shopee', 'guru-do-desconto' ),
			),
		),
		array(
			'slug'             => 'casa',
