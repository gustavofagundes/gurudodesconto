	...
	<div class="container">
		...
		<div class="footer-grid">
			...
			<div class="footer-col">
				<h4><?php esc_html_e( 'Navegação', 'guru-do-desconto' ); ?></h4>
				<ul>
...
<?php if ( ! $conversion ) : ?>
	...
	$float_class = 'floating-whatsapp' . ( $float_group ? ' ' . guru_whatsapp_btn_id( $float_group ) : '' );
	?>
<a <?php echo $float_group ? guru_whatsapp_group_link_attrs( $float_group, 'floating' ) : guru_whatsapp_link_attrs( 'floating' ); ?>
   class="<?php echo esc_attr( $float_class ); ?>"
